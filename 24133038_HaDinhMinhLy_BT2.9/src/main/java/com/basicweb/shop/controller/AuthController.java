...
public class AuthController {
    ...
    public String register(@RequestParam String email,
        ...
        try {
            authService.registerUser(email, fullName, password);
    ...
    public String login(@RequestParam String email,
        ...
        if (user != null) {
            ...
            redirectAttributes.addFlashAttribute("error", "Email hoặc mật khẩu không đúng, hoặc tài khoản chưa kích hoạt.");
            return "redirect:/login";
        }
    }
